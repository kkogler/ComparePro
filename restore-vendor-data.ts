...
import { supportedVendors, supportedVendorRetailVerticals, retailVerticals } from './shared/schema';

// Database connection using the same setup as the main app
const sqlClient = neon(process.env.DATABASE_URL);
const db = drizzle(sqlClient, { 
  schema: { supportedVendors, supportedVendorRetailVerticals, retailVerticals } 
});
