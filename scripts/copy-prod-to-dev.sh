#!/bin/bash
# Copy all production data to dev database
...
echo "🔄 COPY PRODUCTION DATA TO DEV"
echo "==============================="
echo ""
...
echo "1️⃣  Copying data in dependency order..."
echo ""
...
psql "$DEV_DB" <<EOF
SELECT 
  'companies' as "Table", COUNT(*)::text as "Dev Count" FROM companies UNION ALL
