...
INSERT INTO supported_vendors (id, name, vendor_slug, vendor_short_code, api_type, description, credential_fields, features, product_record_priority, is_enabled)
VALUES
  (1, 'GunBroker.com LLC', 'gunbroker', 'GunBroker', 'rest', 'GunBroker marketplace integration', 
  ...
  (2, 'Sports South LLC', 'sports-south', 'Sports South', 'rest', 'Sports South wholesale distributor',
   '[
  ...
  (3, 'Bill Hicks & Co. NAME', 'bill-hicks', 'Bill Hicks', 'ftp', 'Bill Hicks wholesale distributor',
   '[
  ...
  (4, 'Lipsey''s Inc.', 'lipseys', 'Lipsey''s', 'rest', 'Lipsey''s wholesale distributor',
  ...
  (5, 'Chattanooga Shooting Supplies Inc.', 'chattanooga', 'Chattanooga', 'rest', 'Chattanooga wholesale distributor',
   '[
