...
// Object storage client - configured for standard Google Cloud authentication
// For Runway deployment, set GOOGLE_APPLICATION_CREDENTIALS or use service account key
